...
datadir = os.getenv("PROJECT_DIR") + '/results/X86/run_tournament'
...
def plot_O3_W2K():
    ...
    plt.title("Tournament Branch Predictions vs Benchmark (O3_W2K)")

    plt.savefig("fig1-T.png", format='png', dpi=600)
...
def plot_O3_W256():
    ...
    plt.legend(loc=1, prop={'size': 8})
    plt.title("Tournament Branch Predictions vs Benchmark (O3_W256)")

    plt.savefig("fig2-T.png", format='png', dpi=600)
...
def plot_Simple():
    ...
    plt.legend(loc=1, prop={'size': 8})
    plt.title("Tournament Branch Predictions vs Benchmark (Simple)")

    plt.savefig("fig3-T.png", format='png', dpi=600)
...
def plot_DefaultO3():
    ...
    plt.legend(loc=1, prop={'size': 8})
    plt.title("Tournament Branch Predictions vs Benchmark (DefaultO3)")

    plt.savefig("fig4-T.png", format='png', dpi=600)
